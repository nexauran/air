        ...
        <div className="w-full md:w-1/2 flex flex-col gap-5">
          ...
          <div className="space-y-2 border-t border-b border-gray-200 py-5">
            <div className="font-semibold">
              ...
              images and requirements through WhatsApp after payment.
            </div>
          ...
          <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-b-gray-200 py-5 -mt-2">
            <div className="flex items-center gap-2 text-sm hover:text-red-600">
              ...
              <Link href="https://wa.me/917306328115">Ask a question</Link>
            </div>

            <div className="flex items-center gap-2 text-sm hover:text-red-600">
              <TbTruckDelivery className="text-lg" />
              <Link href="https://wa.me/917306328115">Delivery Details</Link>
            </div>

            <div className="flex items-center gap-2 text-sm hover:text-red-600">
              <FiShare2 className="text-lg" />
              <Link href="https://wa.me/917306328115">Contact Us</Link>
            </div>
          </div>
